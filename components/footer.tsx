...
const socialLinks = [
  { icon: Instagram,   href: "https://www.instagram.com/hexed.subit/",  label: "Instagram" },
  { icon: TikTokIcon,  href: "https://www.tiktok.com/@w0xxi3",          label: "TikTok" },
  { icon: Facebook,    href: "https://www.facebook.com/w0xx6",          label: "Facebook" },
    ...
    <footer className="relative border-t border-border py-16">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          >
            <a href="#home" className="mb-4 inline-block text-3xl font-bold tracking-wider text-foreground">
              ѕυвιт
            </a>
            <p className="mb-6 text-sm text-muted-foreground">
              Creator • Designer • Digital Builder
              <br />
              Memes, Art & Good Vibes Only.
            </p>
          </motion.div>
            ...
            <div className="flex flex-wrap gap-3">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="glass-light rounded-lg p-2.5 text-muted-foreground transition-colors hover:text-foreground"
